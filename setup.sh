...
echo "=== 5. Installing LiveKit, Lucide icons, and other UI dependencies in frontend ==="
cd frontend
npm install lucide-react clsx tailwind-merge canvas-confetti @types/canvas-confetti @livekit/components-react livekit-client
cd ..
